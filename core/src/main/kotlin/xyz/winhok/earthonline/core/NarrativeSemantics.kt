...
enum class ScreenSemantic(override val wireId: String) : SemanticKey {
    ...
    NARRATIVE_SYSTEM_BODY("screen.narrative-system-body"),
    EARTH_NATIVE_SYSTEM_NAME("screen.earth-native-system-name"),
    EARTH_NATIVE_SYSTEM_BODY("screen.earth-native-system-body"),
    CULTIVATION_SYSTEM_NAME("screen.cultivation-system-name"),
    CULTIVATION_SYSTEM_BODY("screen.cultivation-system-body"),
    NARRATIVE_PREVIEW_EMPTY("screen.narrative-preview-empty"),
    NARRATIVE_FALLBACK("screen.narrative-fallback"),
